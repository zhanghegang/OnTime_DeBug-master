...
public class StatinSendIMgeAdapter extends RecyclerView.Adapter<StatinSendIMgeAdapter.MyViewHolder> {
    public Context context;
    public List<String> imgs;

    public StatinSendIMgeAdapter(Context context, List<String> imgs) {
